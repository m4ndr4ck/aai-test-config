...
NEXUS_DOCKER_REPO=index.docker.io
DOCKER_REGISTRY=index.docker.io

RESOURCES_DOCKER_IMAGE_VERSION=1.5.0
TRAVERSAL_DOCKER_IMAGE_VERSION=1.5.0
GRAPHADMIN_DOCKER_IMAGE_VERSION=1.5.0
SEARCH_DATA_SERVICE_DOCKER_IMAGE_VERSION=1.3.1
DATA_ROUTER_DOCKER_IMAGE_VERSION=1.4.0
MODEL_LOADER_DOCKER_IMAGE_VERSION=1.4.0
SPARKY_BE_DOCKER_IMAGE_VERSION=1.4.0
CHAMP_DOCKER_IMAGE_VERSION=1.4.0
GIZMO_DOCKER_IMAGE_VERSION=1.4.0
SPIKE_DOCKER_IMAGE_VERSION=1.4.0
BABEL_DOCKER_IMAGE_VERSION=1.4.1
